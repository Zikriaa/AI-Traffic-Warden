...
public class CarAILane1 : MonoBehaviour
{
   ...
   // public bool collisionStop = false;
    ...
    void Awake()
    {
        ...
        Debug.Log("no: " + _random);
        if (_random == 0) CustomDestination = GameObject.Find("Lane1Dest").transform;
        else if (_random == 1) CustomDestination = GameObject.Find("Lane1Dest2").transform;
    }
