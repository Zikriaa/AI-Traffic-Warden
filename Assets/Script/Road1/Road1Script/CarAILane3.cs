...
public class CarAILane3 : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        if(_random == 0) CustomDestination = GameObject.Find("lane3Dest").transform;
        else if (_random == 1) CustomDestination = GameObject.Find("lane3Dest1").transform;
    }
